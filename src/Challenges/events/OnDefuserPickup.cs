...
namespace Challenges
{
    ...
    {
        private HookResult OnDefuserPickup(EventDefuserPickup @event, GameEventInfo info)
        {
            ...
            CheckChallengeGoal(player, "player_defuser_pickup", new Dictionary<string, string>
            {
