...
namespace Challenges
{
    ...
    {
        private HookResult OnExitRescuezone(EventExitRescueZone @event, GameEventInfo info)
        {
            ...
            CheckChallengeGoal(player, "exit_rescuezone", new Dictionary<string, string>
            {
