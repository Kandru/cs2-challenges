...
namespace Challenges
{
    ...
    {
        private HookResult OnEnterRescuezone(EventEnterRescueZone @event, GameEventInfo info)
        {
            ...
            CheckChallengeGoal(player, "enter_rescuezone", new Dictionary<string, string>
            {
